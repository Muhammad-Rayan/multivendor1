      ...
      <div class="card-header border-0 pt-5">
        ...
        <div class="col col-2">
          <div class="card-toolbar">
            <router-link to="/all_orders/create" class="btn btn-sm btn-light btn-active-primary">
...
export default ({
  ...
  methods: {
    ...
    updatePerPage() {
      ...
      get(`/api/order?per_page=${this.params.per_page}&q=${this.params.q}`)
      .then(res => {
          this.setData(res)
      })
    },
    nextPage() {
        if(this.model.next_page_url) {
            ...
            get(`/api/order?per_page=${this.params.per_page}&page=${this.params.page}&q=${this.params.q}`)
            .then(res => {
                this.setData(res)
            })
        }
    ...
    deleteItems(id) {
        byMethod('POST', `/api/order/${id}/delete`)
        .then(({data}) => {
