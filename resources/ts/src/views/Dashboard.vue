      ...
      <div class="col-xl-3">
         ...
         <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
               ...
               <!--end::Svg Icon-->
               <div class="text-white fw-bolder fs-2 mb-2 mt-5">Total Seller</div>
      ...
      <div class="col-xl-3">
         ...
         <a href="#" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body">
               ...
               <!--end::Svg Icon-->
               <div class="text-white fw-bolder fs-2 mb-2 mt-5">Total Product Category</div>
               <div class="fw-bold text-white">100</div>
            </div>
            <!--end::Body-->
         </a>
      ...
      <div class="col-xl-3">
         ...
         <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body">
               ...
               <!--end::Svg Icon-->
               <div class="text-white fw-bolder fs-2 mb-2 mt-5">Total Order</div>
               <div class="fw-bold text-white">30</div>
            </div>
            <!--end::Body-->
         </a>
         <!--end::Statistics Widget 5-->
   ...
   <div class="card-p position-relative">
      ...
      <div class="row g-0">
         ...
         <div class="col bg-warning px-6 py-8 rounded-2 me-7 mb-7">
            ...
            <!--end::Svg Icon-->
            <a href="#" class="text-white fw-bold fs-6">Add New Product</a>
         </div>
         <!--end::Col-->
         <!--begin::Col-->
         <div class="col bg-primary px-6 py-8 rounded-2 mb-7">
            ...
            <!--end::Svg Icon-->
            <a href="#" class="text-white fw-bold fs-6">Manage Seller</a>
         </div>
         <!--end::Col-->
      </div>
      <!--end::Row-->
      ...
      <div class="row g-0">
         <!--begin::Col-->
         <div class="col bg-danger px-6 py-8 rounded-2 me-7">
            ...
            <!--end::Svg Icon-->
            <a href="#" class="text-white fw-bold fs-6 mt-2">Support Section</a>
         </div>
         <!--end::Col-->
         <!--begin::Col-->
         <div class="col bg-success px-6 py-8 rounded-2">
            ...
            <!--end::Svg Icon-->
            <a href="#" class="text-white fw-bold fs-6 mt-2">Reports</a>
         </div>
         <!--end::Col-->
      </div>
      <!--end::Row-->
