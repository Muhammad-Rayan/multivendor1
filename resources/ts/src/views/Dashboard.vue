<template>
<div v-if="model.data != null">
   <div class="row g-5 g-xl-8" v-if="model.data.is_seller == 1">
      <div class="col-xl-3">
         ...
         <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
               ...
               <!--end::Svg Icon-->
               <div class="text-white fw-bolder fs-2 mb-2 mt-5">Total Products</div>
               <div class="fw-bold text-white" v-if="model.data != null" style="text-align: center;font-size: 21px;">{{ model.data.total_products }}</div>
               <div class="fw-bold text-white" v-else  style="text-align: center;font-size: 21px;">0</div>
            </div>
            <!--end::Body-->
         </a>
      ...
      <div class="col-xl-3">
         ...
         <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
               ...
               <!--end::Svg Icon-->
               <div class="text-white fw-bolder fs-2 mb-2 mt-5">Total Orders</div>
               <div class="text-white fw-bolder fs-2 mb-2 mt-5" v-if="model.data != null" style="text-align: center;font-size: 21px;">{{ model.data.total_orders }}</div>
               <div class="fw-bold text-white" v-else  style="text-align: center;font-size: 21px;">0</div>
            </div>
            <!--end::Body-->
         </a>
      ...
      <div class="col-xl-3">
         ...
         <a href="#" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body">
               ...
               <!--end::Svg Icon-->
               <div class="text-white fw-bolder fs-2 mb-2 mt-5">Paid Orders Amount</div>
               <div class="text-white fw-bolder fs-2 mb-2 mt-5" v-if="model.data != null" style="text-align: center;font-size: 21px;">{{ model.data.paid_order }}</div>
               <div class="fw-bold text-white" v-else  style="text-align: center;font-size: 21px;">0</div>
            </div>
            <!--end::Body-->
         </a>
      ...
      <div class="col-xl-3">
         ...
         <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body">
               ...
               <!--end::Svg Icon-->
               <div class="text-white fw-bolder fs-2 mb-2 mt-5">Remaining Orders Amount</div>
               <div class="fw-bold text-white" v-if="model.data != null" style="text-align: center;font-size: 21px;">{{ model.data.unpaid_order }}</div>
               <div class="fw-bold text-white" v-else  style="text-align: center;font-size: 21px;">0</div>
            </div>
            <!--end::Body-->
         </a>
      ...
      <div class="col-xl-3">
         ...
         <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
               ...
               <!--end::Svg Icon-->
               <div class="text-white fw-bolder fs-2 mb-2 mt-5">Approve Refund</div>
               <div class="fw-bold text-white" v-if="model.data != null" style="text-align: center;font-size: 21px;">{{ model.data.approve_refund }}</div>
               <div class="fw-bold text-white" v-else  style="text-align: center;font-size: 21px;">0</div>
            </div>
            <!--end::Body-->
         </a>
      ...
      <div class="col-xl-3">
         ...
         <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
               ...
               <!--end::Svg Icon-->
               <div class="text-white fw-bolder fs-2 mb-2 mt-5">Pending Refund</div>
               <div class="fw-bold text-white" v-if="model.data != null" style="text-align: center;font-size: 21px;">{{ model.data.pending_refund }}</div>
               <div class="fw-bold text-white" v-else  style="text-align: center;font-size: 21px;">0</div>
            </div>
            <!--end::Body-->
         </a>
      ...
      <div class="col-xl-3">
         ...
         <a href="#" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body">
               ...
               <!--end::Svg Icon-->
               <div class="text-white fw-bolder fs-2 mb-2 mt-5">Cancel Refund</div>
               <div class="fw-bold text-white" v-if="model.data != null" style="text-align: center;font-size: 21px;">{{ model.data.cancel_refund }}</div>
               <div class="fw-bold text-white" v-else  style="text-align: center;font-size: 21px;">0</div>
            </div>
            <!--end::Body-->
         </a>
   ...
   <div class="row g-5 g-xl-8" v-if="model.data.is_admin == 1">
      <div class="col-xl-3">
         <!--begin::Statistics Widget 5-->
         <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
            <!--begin::Body-->
      ...
      <div class="col-xl-3">
         ...
         <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body">
               ...
               <!--end::Svg Icon-->
               <div class="text-white fw-bolder fs-2 mb-2 mt-5">Total Sellers</div>
               <div class="fw-bold text-white" v-if="model.data != null" style="text-align: center;font-size: 21px;">{{ model.data.total_sellers }}</div>
               <div class="fw-bold text-white" v-else  style="text-align: center;font-size: 21px;">0</div>
            </div>
            <!--end::Body-->
         </a>
      ...
      <div class="col-xl-3">
         ...
         <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
               ...
               <div class="fw-bold text-white" v-if="model.data != null" style="text-align: center;font-size: 21px;">{{ model.data.total_users }}</div>
               <div class="fw-bold text-white" v-else  style="text-align: center;font-size: 21px;">0</div>
            </div>
            <!--end::Body-->
         </a>
