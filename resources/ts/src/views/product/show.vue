...
<div class="card-body p-9">
										...
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Barcode</label>
											<!--end::Label-->
											<!--begin::Col-->
											<div class="col-lg-8">
...
export default ({
  ...
  methods: {
    ...
    updatePerPage() {
      ...
      get(`/api/product?per_page=${this.params.per_page}&q=${this.params.q}`)
      .then(res => {
          this.setData(res)
      })
    },
    nextPage() {
        if(this.model.next_page_url) {
            ...
            get(`/api/product?per_page=${this.params.per_page}&page=${this.params.page}&q=${this.params.q}`)
            .then(res => {
                this.setData(res)
            })
        }
