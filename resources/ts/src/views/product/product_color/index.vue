      ...
      <div class="card-header border-0 pt-5">
          ...
          <div class="col col-2">
              <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Color</span>
              </h3>
          </div>
          <div class="col col-8">
            <div class="row">
        ...
        <div class="col col-2">
          <div class="card-toolbar">
            <router-link to="/products/color/create" class="btn btn-sm btn-light btn-active-primary">
            ...
            <!--end::Svg Icon-->New Color</router-link>
          </div>
        </div>
...
export default ({
  ...
  methods: {
    ...
    updatePerPage() {
      ...
      get(`/api/product/color?per_page=${this.params.per_page}&q=${this.params.q}`)
      .then(res => {
          this.setData(res)
      })
    },
    nextPage() {
        if(this.model.next_page_url) {
            ...
            get(`/api/product/color?per_page=${this.params.per_page}&page=${this.params.page}&q=${this.params.q}`)
            .then(res => {
                this.setData(res)
            })
        }
    ...
    deleteItems(id) {
        byMethod('POST', `/api/product/color/${id}/delete`)
        .then(({data}) => {
    ...
    editItems(id){
      window.location.href="/admin#/products/color/"+id+"/edit/"
    },
},
  setup() {
